...
-- CreateEnum
CREATE TYPE "ActivityType" AS ENUM ('TASK_CREATED', 'STATUS_CHANGED', 'ASSIGNEE_CHANGED', 'PRIORITY_CHANGED', 'DUE_DATE_CHANGED', 'TASK_OVERDUE');
...
-- CreateIndex
CREATE INDEX "Task_status_isOverdue_dueDate_idx" ON "Task"("status", "isOverdue", "dueDate");
